        ...
        <div className="spial-container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[60px] items-center">
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(159,78,243,0.18) 0%, rgba(124,58,237,0.28) 50%, rgba(107,46,184,0.22) 100%)",
                border: "1px solid rgba(159,78,243,0.2)",
              }}
            >
              <div className="text-center">
                <div style={{ fontSize: 48 }}>🎬</div>
                <div className="font-mono text-sm mt-2" style={{ color: "var(--fg-3)", letterSpacing: "0.1em" }}>EDIFY STUDIO</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="spial-container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[60px] items-center">
            <div
              className="w-full aspect-[4/3] rounded-xl flex items-center justify-center"
              style={{
                background: "linear-gradient(135deg, rgba(107,46,184,0.22) 0%, rgba(159,78,243,0.18) 50%, rgba(99,102,241,0.22) 100%)",
                border: "1px solid rgba(159,78,243,0.2)",
              }}
            >
              <div className="text-center">
                <div style={{ fontSize: 48 }}>💡</div>
                <div className="font-mono text-sm mt-2" style={{ color: "var(--fg-3)", letterSpacing: "0.1em" }}>THE INSIGHT</div>
              </div>
            </div>
            <div>
