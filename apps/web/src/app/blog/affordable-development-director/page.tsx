      ...
      <section className="py-16 bg-[#f7f6f5]">
        <div className="spial-container mx-auto">
          <div className="max-w-[700px] mx-auto">
            ...
            <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">The cost of a development director</h2>
            <p className="text-[#333] leading-[1.8] mb-6">
            ...
            <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">What changes when the gap closes</h2>
            <p className="text-[#333] leading-[1.8] mb-6">
            ...
            <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">This is what we are building toward</h2>
            <p className="text-[#333] leading-[1.8] mb-6">
            ...
            <div className="bg-[#1a2b32] rounded-xl p-8 mt-10 text-white">
              <h3 className="text-lg font-semibold text-[#8B5CF6] mb-3">Ready to hire your Development Director?</h3>
