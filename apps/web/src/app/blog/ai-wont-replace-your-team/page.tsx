    ...
    <div className="spial-page">
      ...
      <section className="bg-[#1a2b32] py-16">
        <div className="spial-container mx-auto">
          ...
          <div className="text-xs text-[#8B5CF6] font-semibold uppercase mb-4">AI for Nonprofits</div>
        ...
        <div className="spial-container mx-auto">
          <div className="max-w-[700px] mx-auto">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-[#333] leading-[1.8] text-lg mb-6 font-medium">
              ...
              <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">The jobs aren&apos;t getting taken. They&apos;re not being done.</h2>
              <p className="text-[#333] leading-[1.8] mb-6">
              ...
              <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">Why the fear makes sense anyway</h2>
              <p className="text-[#333] leading-[1.8] mb-6">
              ...
              <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">What completion actually looks like</h2>
              <p className="text-[#333] leading-[1.8] mb-6">
              ...
              <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">The real risk</h2>
              <p className="text-[#333] leading-[1.8] mb-6">
              ...
              <div className="bg-[#1a2b32] rounded-xl p-8 mt-10 text-white">
                <h3 className="text-lg font-semibold text-[#8B5CF6] mb-3">Ready to meet your team?</h3>
