    ...
    <div className="spial-page">
      ...
      <section className="bg-[#1a2b32] py-16">
        <div className="spial-container mx-auto">
          ...
          <div className="text-xs text-[#8B5CF6] font-semibold uppercase mb-4">Fundraising</div>
      ...
      <section className="py-16 bg-[#f7f6f5]">
        <div className="spial-container mx-auto">
          <div className="max-w-[700px] mx-auto">
            ...
            <p className="text-[#333] leading-[1.8] mb-6 font-medium">
              The thing that kills most grant programs is the research that never happens.
            </p>

            <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">The math problem at the beginning</h2>
            <p className="text-[#333] leading-[1.8] mb-6">
            ...
            <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">The pipeline problem</h2>
            <p className="text-[#333] leading-[1.8] mb-6">
            ...
            <h2 className="text-[26px] font-semibold text-black mt-10 mb-4">What happens when research gets done</h2>
            <p className="text-[#333] leading-[1.8] mb-6">
            ...
            <div className="bg-white border border-[#e5e5e5] rounded-xl p-7 my-10">
              <p className="text-[#555] text-sm leading-[1.8] italic">
              ...
              <p className="text-[#999] text-xs mt-3">-- Development Director, proactive heartbeat</p>
            </div>
            ...
            <div className="bg-[#1a2b32] rounded-xl p-8 mt-10 text-white">
              <h3 className="text-lg font-semibold text-[#8B5CF6] mb-3">Meet your Development Director</h3>
              <p className="text-white/70 text-sm leading-[1.7] mb-5">
                Data-driven. Deadline-aware. Always working the pipeline.
              </p>
              <Link href="/agents/development-director" className="spial-btn no-underline inline-flex">
                Learn More
