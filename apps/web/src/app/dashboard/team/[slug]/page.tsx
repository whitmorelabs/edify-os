...
const SUGGESTED_PROMPTS: Record<string, string[]> = {
  ...
  finance_director: [
    ...
    "Walk me through the March budget variances",
    "What restricted funds are approaching spend-down?",
    "Help me prepare for the board finance committee",
    "What do we need to do before the 990 is due?",
  ],
