    ...
    input_schema: {
      ...
      properties: {
        ...
        content: {
          type: "string",
          description:
            "The post caption / body text. Platform character limits apply (X ~280, LinkedIn ~3000, IG caption ~2200, etc.) — use the user's exact confirmed text, do not paraphrase.",
        },
        image_file_id: {
          type: "string",
          description:
