...
export const socialTools: Anthropic.Tool[] = [
  {
    name: "social_post",
    description:
      "Publish (or schedule) a post to a connected social media account — Instagram, Facebook, LinkedIn, TikTok, X/Twitter, or Threads. CRITICAL: only call this after the user explicitly confirms the caption, image, and platform. If the user says 'draft' or 'preview', do NOT call this tool — show the composition inline instead. Social posts are public and hard to un-send. If the user hasn't connected that platform yet, this returns a structured connection error you should relay to the user (tell them to visit Settings → Integrations).",
    input_schema: {
